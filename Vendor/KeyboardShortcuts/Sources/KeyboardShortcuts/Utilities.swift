...
extension String {
	...
	*/
	var localized: String {
		// 原生 .app 从 Contents/Resources 读取；SwiftPM 开发/测试继续使用 .module。
		let appBundle = Bundle.main.url(forResource: "KeyboardShortcuts_KeyboardShortcuts", withExtension: "bundle")
			.flatMap { Bundle(url: $0) }
		return NSLocalizedString(self, bundle: appBundle ?? .module, comment: self)
	}
}
